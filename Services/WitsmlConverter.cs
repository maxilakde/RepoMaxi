...
namespace WitsmlODViewer.Services
{
    ...
    public class WitsmlConverter
    {
        ...
        {
            var wells = new XElement(Witsml21 + "wells",
                new XAttribute("version", "2.1")
            );

            foreach (var well in root.Elements(Witsml1411 + "well"))
            {
                var convertedWell = new XElement(Witsml21 + "well");
        ...
        {
            var wellbores = new XElement(Witsml21 + "wellbores",
                new XAttribute("version", "2.1")
            );

            foreach (var wellbore in root.Elements(Witsml1411 + "wellbore"))
            {
                var convertedWellbore = new XElement(Witsml21 + "wellbore");
        ...
        {
            var trajectories = new XElement(Witsml21 + "trajectories",
                new XAttribute("version", "2.1")
            );

            foreach (var trajectory in root.Elements(Witsml1411 + "trajectory"))
            {
                var convertedTrajectory = new XElement(Witsml21 + "trajectory");
                ...
                {
                    var convertedStation = new XElement(Witsml21 + "trajectoryStation");
                    ...
                    if (corUsed != null)
                    {
                        var convertedCorUsed = new XElement(Witsml21 + "corUsed");
                        foreach (var child in corUsed.Elements())
                        {
                            var convertedChild = new XElement(Witsml21 + child.Name.LocalName);
        ...
        {
            var mudLogs = new XElement(Witsml21 + "mudLogs",
                new XAttribute("version", "2.1")
            );

            foreach (var mudLog in root.Elements(Witsml1411 + "mudLog"))
            {
                var convertedMudLog = new XElement(Witsml21 + "mudLog");
                ...
                {
                    var convertedInterval = new XElement(Witsml21 + "geologyInterval");
                    ...
                    {
                        var convertedLithology = new XElement(Witsml21 + "lithology");
        ...
        private XElement ConvertLogs(XElement root)
        {
            ...
            var logs = new XElement(Witsml21 + "logs",
                new XAttribute("version", "2.1")
            );

            foreach (var log in root.Elements(Witsml1411 + "log"))
            {
                var convertedLog = new XElement(Witsml21 + "log");
        ...
        {
            var rigs = new XElement(Witsml21 + "rigs", new XAttribute("version", "2.1"));

            foreach (var rig in root.Elements(Witsml1411 + "rig"))
            {
                var convertedRig = new XElement(Witsml21 + "rig");
        ...
        {
            var tubulars = new XElement(Witsml21 + "tubulars", new XAttribute("version", "2.1"));

            foreach (var tubular in root.Elements(Witsml1411 + "tubular"))
            {
                var convertedTubular = new XElement(Witsml21 + "tubular");
        ...
        {
            var wbGeometrys = new XElement(Witsml21 + "wbGeometrys", new XAttribute("version", "2.1"));

            foreach (var wbGeometry in root.Elements(Witsml1411 + "wbGeometry"))
            {
                var converted = new XElement(Witsml21 + "wbGeometry");
        ...
        {
            var bhaRuns = new XElement(Witsml21 + "bhaRuns", new XAttribute("version", "2.1"));

            foreach (var bhaRun in root.Elements(Witsml1411 + "bhaRun"))
            {
                var converted = new XElement(Witsml21 + "bhaRun");
        ...
        {
            var messages = new XElement(Witsml21 + "messages", new XAttribute("version", "2.1"));

            foreach (var message in root.Elements(Witsml1411 + "message"))
            {
                var converted = new XElement(Witsml21 + "message");
        ...
        private XElement ConvertGeneric(XElement root)
        {
            ...
            var convertedRoot = new XElement(Witsml21 + localName,
                new XAttribute("version", "2.1")
            );
        ...
        {
            var converted = new XElement(Witsml21 + source.Name.LocalName);
        ...
        private void ConvertElement(XElement source, XElement target, string sourceName, string targetName)
        {
            ...
            if (element != null)
            {
                var converted = new XElement(Witsml21 + targetName);
